...
from my_jupyter_notebook_kata.algorithms.find_peak import Peak2D
from my_jupyter_notebook_kata.algorithms.find_peak import find_peak_1d
from my_jupyter_notebook_kata.algorithms.find_peak import find_peak_2d
